...
def deliver(args: argparse.Namespace) -> int:
    ...
    folder = args.folder or os.environ.get("RCLONE_ONEDRIVE_DELIVERY_DIR", "01_armel/Curriculos/personalizados")
...
def main() -> int:
    ...
    parser.add_argument("--folder", help="Remote folder. Defaults to RCLONE_ONEDRIVE_DELIVERY_DIR or 01_armel/Curriculos/personalizados.")
