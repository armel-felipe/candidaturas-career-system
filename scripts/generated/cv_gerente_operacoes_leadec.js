...
const tempOutput = path.join(tempDir, "cv_gerente_operacoes_leadec.docx");
  ...
  const doc = new Document({
    ...
    sections: [{
      ...
      children: [
        ...
        secao("Resumo"),
        espaco(3),
        paragrafo("Executivo sênior com trajetória em operações industriais, logística e serviços, com base em Gestao de Operacoes, Gestao Orcamentaria, Excelencia Operacional e Melhoria Continua. No iFood, como Diretor de Operações, gerenciei budget de R$ 300 MM/ano e expansão de 400 para 800 cidades. Na Trifil, reduzi R$ 8 MM de GGF e ampliei o faturamento de R$ 80 MM para R$ 120 MM/ano. Busco posição de Gerente de Operações."),
        ...
        bullet([
          ...
          { text: "Gestao de Operacoes", bold: true },
          { text: " de suporte e CX da wehandle, liderando time de " },
          { text: "30 pessoas", bold: true },
          { text: " com foco em " },
          { text: "Relacionamento com Clientes", bold: true },
          { text: ", produtividade, orçamento e estabilidade da operação." },
        ]),
        bullet([
        ...
        bullet([
          { text: "Fui responsável por operações logísticas nacionais no iFood, com time de " },
          { text: "240 pessoas", bold: true },
          { text: ", " },
          { text: "Gestao Orcamentaria", bold: true },
          { text: " de " },
          { text: "R$ 300 MM/ano", bold: true },
          { text: " e frente de " },
          { text: "Desenvolvimento de Negocios", bold: true },
          { text: " para entrega+, meios de pagamento e frotas dedicadas." },
        ]),
        bullet([
        ...
        bullet([
          ...
          { text: " mantendo a operação estável." },
        ]),
        ...
        bullet([
          ...
          { text: " com foco em " },
          { text: "Excelencia Operacional", bold: true },
          { text: " e nível de serviço." },
        ]),
        bullet([
          { text: "Estruturei torre de operações, métricas em tempo real no Grafana, simulador de nível de serviço e regras operacionais de pricing para calibrar oferta, demanda e disponibilidade por cidade." },
        ]),
        bullet([
          ...
          { text: "60%", bold: true },
          { text: " no México e cortei o custo de distribuição de MPOS em " },
          { text: "80%", bold: true },
          { text: ", além de reduzir o prazo de entrega de " },
        ...
        bullet([
          ...
          { text: " e estruturando a operação com forte " },
          { text: "Relacionamento com Clientes", bold: true },
          { text: " e interface direta com CFO." },
        ]),
        bullet([
          { text: "Estruturei jornada, onboarding, dados diários em SQL e dashboards, além de desenhar a área de CS e contratar sua liderança sem me posicionar como gestor da área." },
        ]),
        bullet([
        ...
        bullet([
          ...
          { text: " a agenda de " },
          { text: "Melhoria Continua", bold: true },
          { text: ", planejamento de produção, MRP corporativo, OTIF e fill rate em uma operação com " },
        ...
        bullet([
          ...
          { text: ", apoiando pricing, indicadores, tendências e " },
          { text: "Aumento de Receita", bold: true },
          { text: " por meio de análises para a diretoria e gestão das franquias." },
        ]),
        bullet([
        ...
        bullet([
          ...
          { text: " para reforçar " },
          { text: "Gestao Orcamentaria", bold: true },
          { text: " e abastecimento." },
        ]),
        bullet([
          { text: "Estruturei critérios de alteração do plano de produção, planejamento de compras de aviamentos, embalagens e fios, e projeto de aquisição de 24 teares circulares automatizados." },
        ]),
        bullet([
        ...
        bullet([
          { text: "Fui responsável pelo centro de expedição da Trifil, cobrindo picking, packing, armazenamento e devoluções com foco em " },
          { text: "Excelencia Operacional", bold: true },
          { text: ", qualidade de entrega e produtividade." },
        ]),
        bullet([
          { text: "Implantei endereçamento, inventário rotativo, coletores por radiofrequência e ERP LN, além de redesenhar layout e criar sistema visual de abastecimento do picking." },
        ]),
        bullet([
        ...
        secao("Stack técnica"),
        espaco(3),
        paragrafo("Excel/VBA · SQL · Python · Databricks · Grafana · Power BI · ERP Infor LN · WMS · Zendesk"),
