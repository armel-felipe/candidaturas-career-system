...
# NOTE: changed from http://localhost:1 (gives redirect_uri_mismatch on Desktop app
# clients without that URI whitelisted) to http://localhost, which the Google
# Desktop app OAuth client accepts by default without manual URI configuration.
