...
Manutenção canônica desta skill: `.opencode/skills/networking-message/SKILL.md`.

Qualquer ajuste nesta skill deve ser feito no caminho canônico em `.opencode/skills/networking-message/SKILL.md`.

## Adaptação Local OpenCode

Leia também `../career-system/SKILL.md`. Use `.career-state/fit_map.json` quando houver vaga analisada e referências em `../career-system/references/`. Continue perguntando o perfil do destinatário antes de gerar qualquer mensagem.
