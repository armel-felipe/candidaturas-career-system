...
Carregue os módulos declarados no front matter antes de executar. Esta skill existe para produzir uma saída curta, útil para formulário de candidatura, com foco nas keywords mais relevantes que já têm evidência real na base.
