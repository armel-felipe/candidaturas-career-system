...
Carregue os módulos declarados no front matter. Use `.career-state/fit_map.json` como FIT_MAP ativo quando houver vaga e `../career-system/references/diretrizes para carta de apresentação.md` como referência da carta. Após redigir, acione `output-reviewer` antes de entregar.
