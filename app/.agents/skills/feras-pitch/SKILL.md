...
Carregue os módulos declarados no front matter. Use `.career-state/fit_map.json` como FIT_MAP ativo e referências em `../career-system/references/`. Após gerar o texto, acione `output-reviewer` antes de exibir ao usuário.
